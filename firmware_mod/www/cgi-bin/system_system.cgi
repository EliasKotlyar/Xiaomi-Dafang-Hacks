...
cat << EOF
  ...
  <article class="message is-warning">
    ...
    <div class="message-body">
      ...
      <br>
      <p>Please try rebooting. If the problem persists, please <a target="_blank" href="https://github.com/stoickish/Xiaomi-Dafang-Hacks/search?q=read+only+sdcard&type=Issues">search
